...
public class Utils {
    ...
    public static int diferenciasDeFechas(Date fechaInicial, Date fechaFinal) throws ParseException {
    ...
    public static synchronized Date sumarDias(Date fecha, int dias) {
